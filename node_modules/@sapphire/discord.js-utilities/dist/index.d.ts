...
import { MessageCreateOptions, CategoryChannel, DMChannel, PartialDMChannel, NewsChannel, StageChannel, TextChannel, ThreadChannel, VoiceChannel, GuildChannel, Channel, Message, ChatInputCommandInteraction, UserContextMenuCommandInteraction, MessageContextMenuCommandInteraction, AutocompleteInteraction, SelectMenuInteraction, ButtonInteraction, Interaction, PartialTextBasedChannelFields, EmojiIdentifierResolvable, User, CollectorFilter, MessageReaction, CollectorOptions, GuildEmoji, ReactionEmoji, EmojiResolvable, InteractionButtonComponentData, LinkButtonComponentData, StringSelectMenuComponentData, StringSelectMenuInteraction, APIMessage, CommandInteraction, InteractionCollector, EmbedBuilder, BaseMessageOptions, SelectMenuComponentOptionData, MessageComponentInteraction, WebhookEditMessageOptions, Guild, InteractionReplyOptions, InteractionUpdateOptions, MessageReplyOptions, MessageEditOptions, TextBasedChannel, Collection, Snowflake, EmbedData, EmbedField, ActionRowComponentOptions, ButtonComponentData, ButtonBuilder, StringSelectMenuBuilder, JSONEncodable, APIActionRowComponent, APIButtonComponent, APIStringSelectComponent, ActionRowData, PartialGroupDMChannel, VoiceBasedChannel, GuildMember, APIGuildMember, APIInteractionGuildMember, APIInteractionDataResolvedGuildMember } from 'discord.js';
 ...
 */
type NonModalInteraction = ChatInputOrContextMenuCommandInteraction | AutocompleteInteraction | SelectMenuInteraction | ButtonInteraction;
/**
...
type PaginatedMessageMessageOptionsUnion = Omit<BaseMessageOptions, 'flags'> | WebhookEditMessageOptions;
/**
 ...
 */
declare function isAnyInteraction(messageOrInteraction: APIMessage | Message | Interaction): messageOrInteraction is Interaction;
declare function isAnyInteractableInteraction(messageOrInteraction: APIMessage | Message | Interaction): messageOrInteraction is AnyInteractableInteraction;
/**
