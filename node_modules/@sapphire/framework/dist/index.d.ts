import { Piece, Store, StoreRegistry, AliasPiece, AliasPieceJSON, AliasStore, PieceContext } from '@sapphire/pieces';
...
import { Interaction, Client, ClientEvents, Snowflake, Message, AutocompleteInteraction, ChatInputCommandInteraction, ContextMenuCommandInteraction, ChatInputApplicationCommandData, UserApplicationCommandData, MessageApplicationCommandData, ApplicationCommandManager, Collection, ApplicationCommand, DMChannel, CategoryChannel, NewsChannel, ThreadChannel, TextChannel, StageChannel, VoiceChannel, GuildMember, Role, User, PermissionsBitField, CommandInteraction, TextBasedChannel, PermissionResolvable, ClientOptions, Events as Events$1, PermissionsString, Guild, PartialDMChannel } from 'discord.js';
...
declare class CorePrecondition$c extends AllFlowsPrecondition {
    ...
    messageRun(message: Message, _: Command, context: PermissionPreconditionContext): AllFlowsPrecondition.Result;
